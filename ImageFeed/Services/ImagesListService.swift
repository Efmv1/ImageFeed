...
final class ImagesListService {
    ...
    func fetchPhotosNextPage() {
        ...
        guard let request = createImageListRequest(nextPage) else {
            fatalError("[ImagesListService]: Failed to create URL")
        }
    ...
    func changeLike(photoId: String, isLike: Bool, _ completion: @escaping (Result<Void, Error>) -> Void) {
        ...
        guard let request = createLikeRequest(photoId: photoId, isLike) else {
            fatalError("[ImagesListService]: Failed to create URL")
        }
    ...
    private func createLikeRequest(photoId: String, _ isLike: Bool) -> URLRequest? {
